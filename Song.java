...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	{
		// calls printInfo from AudioContent
		super.printInfo();
		// prints the other info for a Song
	...
	public boolean equals(Object other)
	{
		...
		return (super.equals(otherSong) && getComposer() == otherSong.getComposer() && getArtist() == otherSong.getArtist());
	}
	...
	{
		// uses the String compareTo method to compare song titles
